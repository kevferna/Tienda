    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/slider1.jpg" style="weight" alt="slider1">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 text-center">
                                   <article style="margin-top:5%;">
                                        ...
                                        <h3>Regístrate</h3>
                                        <p>Regístrate como cliente de <span class="tittles-pages-logo"><strong>TienDAW</strong></span> en un sencillo formulario para poder completar tus pedidos</p>
                                        <p><a href="registration.php" class="btn btn-primary btn-raised btn-block">Registrarse</a></p>   
                                   </article>
                                </div>
                
                                <div class="col-xs-12 col-sm-6">
                                    <img src="assets/img/daw_logo.png" alt="daw_logo" class="img-responsive" style="width: 70%; display: block; margin: 0 auto;">
                                </div>
                            </div>
                        </div>
                    </section>';
