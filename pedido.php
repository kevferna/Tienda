    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>PEDIDOS <small class="tittles-pages-logo">TienDAW</small></h1>
            </div>
            <br><br><br>
            <div class="row">
              ...
              <strong>Tipo de cuenta:</strong> <?php echo $datBank['TipoCuenta']; ?><br><br>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="tipo-envio" data-toggle="tooltip" data-placement="top" title="Elige El Tipo De Envio">
                      ...
                      <option value="Envio Por UPS">Envio Gratis</option> 
                  </select>
               </div>
                <div class="form-group">
                ...
                <?php else: ?>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="tipo-envio" data-toggle="tooltip" data-placement="top" title="Elige El Tipo De Envio">
                          <option value="" disabled="" selected="">Selecciona una opción</option>
                          <option value="Recoger en tienda">Recoger Por Tienda</option>
                          <option value="Envio por UPS">Envio Gratis</option> 
                      </select>
                   </div>
