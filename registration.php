    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">TienDAW</small></h1>
            </div>
            
           <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="./assets/img/registration.png" alt="pcimg" class="img-responsive my-auto">
                    </figure>
                </div>
                <div class="col-sm-7">
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                  ...
                                  <input class="form-control" type="text" required name="clien-lastname" title="Ingrese sus apellidos (solamente letras)" pattern="[a-zA-Z ]{1,50}" maxlength="50">
                                </div>
                              </div>
                              <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
