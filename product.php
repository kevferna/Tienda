       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>PRODUCTOS <small class="tittles-pages-logo">TienDAW</small></h1>
            </div>
            <?php
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <span class="input-group-btn">
                              <button class="btn btn-secondary btn-raised" type="submit">Buscar</button>
                          </span>
                        </div>
                      </div>
                    </form>
                ...
                <?php
                  ...
                  if(mysqli_num_rows($consultar_productos)>=1){
                    echo '<h3 class="text-center">Se muestran los productos de la categoría <strong>"'.$datCat['Nombre'].'"</strong></h3><br>',
                          '<p class="text-center">'.$datCat['Descripcion'].'<p><br>';
            ...
            <?php
                  ...
                  echo '<h2 class="text-center">Por favor, seleccione una categoría para empezar</h2>',
                      '<img src="assets/img/smile.png" alt="smile" class="img-responsive" style="width: 20%; display: block; margin: 0 auto; margin-top: 20px;">';
                }
              else:
